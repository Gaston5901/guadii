...
var tl = gsap.timeline()
    ...
    //message and glow
    .fromTo('.message-kicker', { autoAlpha: 0, y: 14 }, { duration: 0.7, autoAlpha: 1, y: 0, ease: 'power2.out' }, 'flower1+=0.15')
    .fromTo('.message-title', { autoAlpha: 0, y: 18, scale: 0.98 }, { duration: 1, autoAlpha: 1, y: 0, scale: 1, ease: 'power2.out' }, 'flower2-=0.15')
    .fromTo('.message-subtitle', { autoAlpha: 0, y: 18 }, { duration: 0.9, autoAlpha: 1, y: 0, ease: 'power2.out' }, 'flower3-=0.05')
    .fromTo('.sparkle', { autoAlpha: 0 }, { duration: 1, autoAlpha: 1, stagger: 0.08, ease: 'power2.out' }, 'flower3+=0.4')